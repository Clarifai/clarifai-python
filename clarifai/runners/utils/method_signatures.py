...
_DATA_TYPES = {
  str: _DataType(resources_pb2.ModelTypeField.DataType.STR, AtomicFieldSerializer('string_value')),
  bytes: _DataType(
  ...
  bool: _DataType(resources_pb2.ModelTypeField.DataType.BOOL, AtomicFieldSerializer('bool_value')),
