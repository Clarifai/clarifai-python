        ...
        try:
            ...
            if len(inputs) == 1:
                ...
                if _can_fast_serialize:
                    ...
                    _fast_sig_default = data_utils.Param.get_default(output_fields[0])
                for output in method(**inputs):
                    ...
                    if _can_fast_serialize:
                        ...
                        # Preserve serialize()'s None/default handling: skip the part
                        # when output is None and the signature default is also None.
                        if not (output is None and _fast_sig_default is None):
