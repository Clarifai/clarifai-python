...
class Dataset(Lister, BaseClient):
  ...
  def __init__(self,
    ...
    Args:
        ...
        version_id (str): The Dataset Version ID within the Dataset to interact with.
    ...
    if url:
      user_id, app_id, _, dataset_id, version_id = ClarifaiUrlHelper.split_clarifai_url(url)
      kwargs = {'user_id': user_id, 'app_id': app_id}
    dataset_version = {
        'id': version_id
    } if version_id else kwargs['version'] if 'version' in kwargs else None
