...
from clarifai_grpc.grpc.api.resources_pb2 import Annotation, Input, Data, Image, Video, Audio, Text
...
class Inputs(Lister, BaseClient):
    ...
    def get_input_from_url(self, input_id: str , image_url: str = None, video_url: str = None, audio_url: str = None, text_url:str = None ,dataset_id: str = None, **kwargs) -> Input:
        ...
        if not any((image_url, video_url, audio_url, text_url)):
            raise ValueError("At least one of image_url, video_url, audio_url, text_url must be provided.")
    ...
    def get_image_inputs_from_folder(self, folder_path: str, dataset_id: str = None) -> List[Input]: #image specific
    ...
    def get_text_input(self, input_id: str, raw_text: str, dataset_id: str = None, **kwargs) -> Text: #text specific
    ...
    def upload_from_bytes(self, input_id: str, image_bytes: bytes = None, video_bytes: bytes = None, audio_bytes: bytes = None, dataset_id: str = None, **kwargs) -> str:
        ...
        """
        input_pb = self.get_input_from_bytes(input_id, image_bytes, video_bytes, audio_bytes, dataset_id, **kwargs)
        return self.upload_inputs([input_pb])

    def upload_text(self, input_id: str, raw_text: str, dataset_id: str = None, **kwargs) -> str: #text specific
        ...
        """
        input_pb = self._get_proto(input_id, dataset_id, text_pb = resources_pb2.Text(raw=raw_text), **kwargs)
        return self.upload_inputs([input_pb])
