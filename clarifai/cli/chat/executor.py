...
def parse_commands_from_response(response_text: str) -> Tuple[List[Tuple[str, List[str], str]], List[Tuple[str, str]]]:
    ...
    def process_python_code(code: str):
        ...
        if has_placeholder:
            skipped.append((code[:80] + "..." if len(code) > 80 else code, f"contains placeholder '{placeholder}'"))
