...
def local_dev(ctx, model_path):
  ...
  leverage local compute resources manually. This relies on many variable being present in the env
  ...
  # node the user_id of the compute cluster is the same as the user_id of the model.
