...
For more details on the installation, please refer to https://clarifai-python.readthedocs.io/en/v2.0.25/install/
...
For AWS or Windows users, please refer to https://clarifai-python.readthedocs.io/en/v2.0.25/install/ for more instructions.
...
Documentations
---------------------
Read more code examples and references at https://clarifai-python.readthedocs.io/en/v2.0.25/index.html
